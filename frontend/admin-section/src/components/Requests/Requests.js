  ...
  return (
    ...
    >
      {props.rqstArray.map((res, index) => (
        <div onClick={()=>props.setverifyRqst(!props.verifyRqst)} className="cursor my-4 text-center d-flex flex-column align-items-center justify-content-center rqst-block">
