...
const EditorProfileStatisticsSection = (props) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.status === 200) {
          ...
          // setLeagueFootballData(res.data[1].football_Leagues);
  ...
  const displayLeague =
    (SelectSport === "football" && leagueFootballData) ||
    (SelectSport === "basketball" && leagueBasketballData);
