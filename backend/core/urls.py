...
from core.views import (RetrieveCommentatorView, FollowCommentatorView, CommentView, NotificationView, SubscriptionView,
                        ...
                        #  GetPendingBalance, TransactionHistory, UserTransactionHistory, TestCronView,
                         ...
                         ClearTokenView, RetrieveUserUsingToken,
...
urlpatterns = [
    ...
    path('renew-model-data/', RenewModelData.as_view(), name='Renew-Model-Data'),
    ...
    path('check-deactivated-account/', CheckDeactivatedAccount.as_view(), name='bank-details'),
    path('user-data/', GetUserdata.as_view(), name='User-Data'),
    ...
    path('account-status/', AccountStatus.as_view(), name='transcation-query'),
    path('retrieve-user-using-token/', RetrieveUserUsingToken.as_view(), name='Retrieve-User-Using-Token'),
