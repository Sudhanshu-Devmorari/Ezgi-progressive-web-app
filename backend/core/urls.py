...
urlpatterns = [
    ...
    path('fav-editor-comment/', RetrieveFavEditorsAndFavComment.as_view(), name='FavEditors-FavComment'),
    ...
    path('retrieve-subscribers-subscription/', RetrieveSubscriberListAndSubscriptionList.as_view(), name='SubscriberList-SubscriptionList'),
