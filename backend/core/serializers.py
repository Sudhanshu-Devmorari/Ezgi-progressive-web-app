...
class EditorBannerSerializer(serializers.ModelSerializer):
    class Meta:
        model = EditorBanner
        fields = '__all__'

class PendingBalanceHistorySerializer(serializers.ModelSerializer):
    user = UserSerializer()
    editor = UserSerializer()
    class Meta:
        model = PendingBalanceHistory
        fields = '__all__'
...
class WithdrawableSerializer(serializers.ModelSerializer):
...
class WithdrawalSettingSerializer(serializers.ModelSerializer):
    class Meta:
